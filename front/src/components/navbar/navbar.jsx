...
const navbar = () => {
  ...
  return (
    <>
      <nav className="z-50 relative flex bg-zinc-800 bg-gradient-to-r from-zinc-400 via-blue-100 to-zinc-400 text-white px-8 py-4 items-center justify-between">
