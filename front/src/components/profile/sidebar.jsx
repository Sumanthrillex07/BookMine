...
const sidebar = ({ data }) => {
  ...
  return (
    <div className="bg-white rounded-xl p-4 flex flex-col items-center justify-between h-auto lg:h-[100%]">
      ...
      <button
        className="bg-white text-red-400 w-3/6 lg:w-full mt-4 lg:mt-0 text-red font-bold  flex items-center justify-center py-2 rounded-xl hover:bg-red-600 hover:text-white transition-all duration-300"
        onClick={() => {
