    ...
    <>
      ...
      {order && order.length > 0 && (
        <div className="h-[100%] p-0 md:p-4 text-zinc-100">
          ...
          {order &&
            order.map((items, i) => (
              <div className="bg-white w-full text-black rounded py-2 px-4 flex gap-2 hover:bg-green-200 hover:text-white hover:cursor-pointer transition-all duration-300">
                <div className="w-[3%]">
